...
function getAnnuncio($idAnnuncio){
    global $con;
        ...
        JOIN `tipologiabarca` ON `idTip` = `idTipologia`
        JOIN `marca` ON `marca` = `idMarca`
        JOIN `materialescafo` ON `scafo` = `idMateriale`
...
/**
 * @param $idScafo  contiene interno relativo ad idScafo
 * @return string|null contiene  il nome dello scafo relativo
 */
function getNomeScafo($idScafo){
    global $con;
    $sql = 'SELECT `nomeMateriale` 
    FROM `materialescafo` 
    WHERE `idMateriale` ="'.$idScafo.'"';
 ...
 * @return array|null contiene  array N array associativi . uno per tipologiaBarca legata all'annuncio
 */
...
/**
 * @return array|null contiene  array N array associativi . uno per tipologia barca
 */
function getAllTipologie(){
    global $con;
    $sql = 'SELECT *  FROM `tipologiabarca` ';
...
/**
 * @return array|null contiene  array N array associativi . uno per tipologia scafo
 */
function getAllScafi(){
    global $con;
    $sql = 'SELECT *  FROM `materialescafo` ';
...
/**
 * @param $idAnnuncio  contiene interno relativo ad idAnnuncio
 * @return int|null contiene  nMotori di determinato annuncio
 */
function getNMotori ($idAnnuncio){
    $output =getAnnuncio($idAnnuncio);
    return $output[0]["nMotori"];
}
/**
 * @param $idAnnuncio  contiene interno relativo ad idAnnuncio
...
/**
 * @param $idAnnuncio  contiene interno relativo ad idAnnuncio
 * @return int|null contiene  id dello scafo di determinato annuncio
 */
function getIdScafo($idAnnuncio){
    $output =getAnnuncio($idAnnuncio);
    return $output[0]["scafo"];
}
/**
 * @param $idAnnuncio  contiene interno relativo ad idAnnuncio
...
/**
 * @param $idAnnuncio  contiene interno relativo ad idAnnuncio
 * @return int|null contiene  1 se power 0 se Sail
 */
function isPower($idAnnuncio){
    $output =getAnnuncio($idAnnuncio);
    return $output[0]["PowerSail"];
}
...
/**
 * @param $idAnnuncio  contiene interno relativo ad idAnnuncio
 * @return string|null contiene  nome Barca
 */
function getNomeBarca($idAnnuncio){
    $output =getAnnuncio($idAnnuncio);
    return $output[0]["nomeBarca"];
}
...
function getIdMaterialeScafoFromName($nome){
	global $con;
    $sql = 'SELECT `idMateriale`
    FROM `materialescafo` 
    WHERE `nomeMateriale` ="'.$nome.'"';
